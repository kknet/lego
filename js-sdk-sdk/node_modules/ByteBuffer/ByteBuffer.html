...
<head>
    <meta charset="UTF-8">
    <title>ByteBuffer for browser</title>
</head>
...
<body>
    <script type="text/javascript">
        ...
        */
        var ByteBuffer = function (arrayBuf, offset) {
        ...
        var buffer = sbuf.string('abc123你好')//变长字符串，utf8编码，前4个字节表示字符串长度
            ...
            .byte(255)
            .vstring('abcd', 10)//定长字符串，utf8编码,不足的字节补0x00
            .byteArray(new Uint8Array([65, 66, 67, 68, 69]), 5)//字节数组，不足字节补0x00
            .pack();//结尾调用打包方法
        ...
        var arr = rbuf.string()//变长字符串，utf8编码，前4个字节表示字符串长度
            ...
            .byte()
            .vstring(null, 10)//定长字符串，utf8编码,不足的字节补0x00
